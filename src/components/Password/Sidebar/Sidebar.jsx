...
const Sidebar = ({view}) => {
  ...
  return (
    <>
    <div className='hidden md:block flex flex-col lg:h-200 md:h-200 w-[17%] bg-[#1C2059] text-white items-center md:pt-20 lg:pt-30 fixed left-0'>
    ...
    {view && (
        <div className='fixed bg-[#1C2059] text-white h-250 z-100 pt-20 p-4'>
          <div className=' w-full pb-3'>
        <div href="dashbord" className='hover:bg-[#FFAC06] flex flex-row mt-4 px-5 py-2'><span className='mr-4'><img src={dashboardIcon} alt="dashboard Icon" /></span>Dashboard</div>      
