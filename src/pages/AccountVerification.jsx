...
//       <div className="lg:h-screen lg:w-1/2 bg-[#1C2059] flex flex-col items-center justify-center">
...
//           <img src={img} alt="Super Admin" className="w-80 mt-5" />
//         </div>
//       </div>

//       <div className="sm:h-screen flex flex-col items-center justify-center bg-gray-100 p-6 lg::w-1/2">
...
//         <div className="w-full max-w-sm p-4 rounded-lg  mt-4 text-center border border-[#7900BA]">
//           <div className="flex items-center justify-center p-2">
//             <span>
//               <img src={call} alt="Phone Icon" className="w-5" />
//             </span>
//             <p className="text-gray-700 mx-6">+91 9876543210</p>
//             <span>
//               <img src={edit} alt="Edit Icon" className="w-5" />
//             </span>
//           </div>
//           <button className="mt-2 w-1/2 bg-[#1C2059] text-white py-2 rounded-lg">
//             Select Phone
//           </button>
//         </div>

//         <div className="w-full max-w-sm p-4 mt-4 rounded-lg text-center border border-[#7900BA]">
//           <div className="flex items-center justify-center p-2">
//             <span>
//               <img src={email} alt="Email Icon" className="w-5" />
//             </span>
//             <p className="text-gray-700 mx-6">techno@gmail.com</p>
//             <span>
//               <img src={edit} alt="Edit Icon" className="w-5" />
//             </span>
//           </div>
...
//         <button className="mt-8 w-full max-w-sm bg-[#1C2059] text-white py-2 rounded-lg">
//           Continue
//         </button>
//       </div>
//     </div>
